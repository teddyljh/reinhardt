...
/*
singlerun_fullalg.cpp

given statically defined f2 and f3 values (set in the main method),
this program constructs the associated g2/g3 sequences and then,
according to the necessary restrictions, constructs all possible
g1 and thus F. If an F represents a valid Reinhardt polynomial,
the result is then outputed to the user.
...
const int n = p*l*q*r;
int g1[n], g2[n], g3[n], f1[35], f2[21], f3[15], F[n], inter[n], repf2[7], repf3[5];
...
int main() {
	...
	*/
	...
	f2[2] = f2[6] = f2[12] = f2[18] = -1; //ROBERT FIRST TRY 
	...
	f1[8] = f1[10] = f1[19] = f1[21] = f1[27] = f1[30] = f1[35] = 1;
	f1[9] = f1[15] = f1[20] = f1[26] = f1[28] = f1[32] = -1;
...
void printGaps1(int* v, int n) { /*gives us the actual "list sequence" of numbers for the Reinhardt angle differences*/
    int allF[n];
