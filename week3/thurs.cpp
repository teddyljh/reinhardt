...
int produceArray(int i, int prev1, int prev2, int prev3, int result) {
	...
	//fcout << "i: " << i << " " << "result: " << result << " " << "prevs: " << prev1 << " " << prev2 << " " << prev3 << endl;
	if (i==35) {
		//printAns();
